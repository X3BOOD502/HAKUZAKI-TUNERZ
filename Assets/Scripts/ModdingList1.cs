...
public class ModdingList1 : MonoBehaviour
{
    private float RNG = 1;
    public bool RE = true;
    ...
    public MeshRenderer ZZZLMirror;
    public MeshRenderer ZZZRMirror;
    ...
    void Start()
    {
        ...
        else
        {
            ...
            RNG = Random.Range(1, 3); if (RNG == 1) { hood = true; }
            if (RNG == 2) { hood = false; }
            RNG = Random.Range(1, 3); if (RNG == 1) { stockbody = true; }
            if (RNG == 2) { widebody = true; }
            RNG = Random.Range(1, 3); if (RNG == 1) { spoiler = true; }
            if (RNG == 2) { spoiler = false; }
            RNG = Random.Range(1, 4); if (RNG == 1) { brakesLVL1 = true; }
            if (RNG == 2) { brakesLVL2 = true; }
            if (RNG == 3) { brakesLVL3 = true; }
            RNG = Random.Range(1, 4); if (RNG == 1) { exhaustLVL1 = true; }
            if (RNG == 2) { exhaustLVL2 = true; }
            if (RNG == 3) { exhaustLVL3 = true; }
            RNG = Random.Range(1, 4); if (RNG == 1) { intakeLVL1 = true; }
            if (RNG == 2) { intakeLVL2 = true; }
            if (RNG == 3) { intakeLVL3 = true; }
        }
    }
    void Update()
    {
        ...
        ZZZLMirror.materials[0].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZRMirror.materials[0].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZLDoor.materials[0].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZLDoor.materials[1].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZRDoor.materials[0].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZRDoor.materials[1].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ...
        ZZZStockbody.materials[5].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZWidebody.materials[1].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZWidebody.materials[5].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ...
        ZZZBlock.materials[3].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ZZZExhaustLVL3.materials[1].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ZZZIntakeLVL1.materials[2].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ZZZIntakeLVL1.materials[3].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ZZZIntakeLVL2.materials[2].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ZZZIntakeLVL2.materials[3].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ZZZIntakeLVL3.materials[1].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        /// EZ GAZI PRODUKTIONZ
        /// EZ GAZI PRODUKTIONZ
        /// EZ GAZI PRODUKTIONZ
        ...
        ZZZLMirror.materials[0].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZRMirror.materials[0].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZLDoor.materials[0].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZLDoor.materials[1].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZRDoor.materials[0].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZRDoor.materials[1].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZHood.materials[0].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZStockbody.materials[1].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZStockbody.materials[5].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZWidebody.materials[1].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZWidebody.materials[5].SetFloat("_Metallic", bodyMETAL / 255f);
        ...
        ZZZIntakeLVL1.materials[3].SetFloat("_Metallic", engineMETAL / 255f);
        ZZZIntakeLVL2.materials[2].SetFloat("_Metallic", engineMETAL / 255f);
        ZZZIntakeLVL3.materials[1].SetFloat("_Metallic", engineMETAL / 255f);
    }
}
