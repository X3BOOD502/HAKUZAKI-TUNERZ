...
public class ModdingList2 : MonoBehaviour
{
    private float RNG = 1;
    public bool RE = true;
    ...
    public MeshRenderer ZZZLLDoor;
    public MeshRenderer ZZZRRDoor;
    ...
    void Update()
    {
        ...
        ZZZLLDoor.materials[0].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZRRDoor.materials[0].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ...
        ZZZBlock.materials[1].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ...
        ZZZIntakeLVL2.materials[1].color = new Color(engineR / 255f, engineG / 255f, engineB / 255f);
        ...
        ZZZLLDoor.materials[0].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZRRDoor.materials[0].SetFloat("_Metallic", bodyMETAL / 255f);
        ...
        ZZZBlock.materials[1].SetFloat("_Metallic", engineMETAL / 255f);
        ZZZIntakeLVL1.materials[3].SetFloat("_Metallic", engineMETAL / 255f);
        ZZZIntakeLVL2.materials[1].SetFloat("_Metallic", engineMETAL / 255f);
