...
public class ModdingList3 : MonoBehaviour
{
    private float RNG = 1;
    public bool RE = true;
    ...
    public MeshRenderer ZZZHeadLights;
    ...
    void Update()
    {
        ...
        ZZZHeadLights.materials[1].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ...
        ZZZStockbody.materials[2].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ZZZWidebody.materials[2].color = new Color(bodyR / 255f, bodyG / 255f, bodyB / 255f);
        ...
        ZZZHeadLights.materials[1].SetFloat("_Metallic", bodyMETAL / 255f);
        ...
        ZZZStockbody.materials[2].SetFloat("_Metallic", bodyMETAL / 255f);
        ZZZWidebody.materials[2].SetFloat("_Metallic", bodyMETAL / 255f);
